...
**A reusable [Home Manager](https://nix-community.github.io/home-manager/) base — shell, editor, git, and CLI toolbelt in one flake.**
...
- **One import, a full environment** — shell (bash/zsh/fish), a plain neovim editor, git + delta, gh, direnv, mise, atuin.
...
# flake.nix
{
  inputs = {
    ...
    harus-config.url = "github:azusachino/harus-config/v0.2.5"; # pin a tag
  };
