---
name: repo-scout
description: Scans a repository and reports stack, conventions, and commands. Use before asking stack questions about an unfamiliar repo, or to bootstrap AGENTS.md content.
model: sonnet
color: purple
---
